...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [attrString setAttributes:@{NSFontAttributeName:[UIFont systemFontOfSize:_appearance.preferredHeaderTitleFont.pointSize]} range:NSMakeRange(text.length - 4, 4)];
...
//        UIView *underLineView = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 80, 4)];
//        underLineView.backgroundColor = [UIColor colorWithRed:165/255.0 green:17/255.0 blue:1/255.0 alpha:1.0];
//        [self.titleLabel addSubview:underLineView];
...
//    self.underLineView.center = CGPointMake(self.titleLabel.center.x, self.titleLabel.center.y + 18);
