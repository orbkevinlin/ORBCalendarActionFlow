...
- (UIColor *)colorForCurrentStateInDictionary:(NSDictionary *)dictionary
{
    ...
    if (self.dateIsExpired && !self.placeholder && [[dictionary allKeys] containsObject:@(FSCalendarCellStateExpired)]) {
        return dictionary[@(FSCalendarCellStateExpired)];
    }
