...
typedef NS_ENUM(NSInteger, FSCalendarCellState) {
    ...
    FSCalendarCellStateExpired     = 1 << 5,
    FSCalendarCellStateExpiredSelected = FSCalendarCellStateExpired|FSCalendarCellStateSelected,
...
/**
 * The fill color of the shape for expired state.
 */
@property (nonatomic, strong) UIColor *expirationColor;

/**
 * The fill color of the shape for select expired state
 */
@property (strong, nonatomic) UIColor *selectExpirationColor;
